    ...
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden bg-warm-ivory">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl space-y-6 animate-fade-in">
          {/* Tagline Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-soft-beige/80 border border-warm-taupe/30 text-charcoal text-xs sm:text-sm font-medium backdrop-blur-sm shadow-sm">
            <Sparkles className="w-4 h-4 text-deep-olive" />
            <span>Premium Interior Design & PVC Panel Architecture</span>
          </div>

          {/* Hero Main Heading */}
          <h1 className="font-serif text-4xl sm:text-6xl lg:text-7xl font-bold text-charcoal leading-[1.1] tracking-tight">
            Transform Your Space Into <span className="italic font-normal text-deep-olive">Something Extraordinary</span>
          </h1>

          {/* Subheading */}
          <p className="text-base sm:text-xl text-charcoal/80 font-normal leading-relaxed max-w-2xl">
            {settings?.hero?.subtitle ||
              'Premium interior design, false ceiling, PVC panel and wall design solutions crafted for modern homes and spaces.'}
          </p>

          {/* Highlights Checklist */}
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs sm:text-sm text-charcoal/90 pt-2 font-medium">
          ...
          <div className="pt-6 flex items-center gap-4 text-xs text-charcoal/80">
